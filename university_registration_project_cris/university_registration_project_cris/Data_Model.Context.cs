...
namespace university_registration_project_cris
{
    ...
    public partial class DB_UNIVERSITY_REGISTRATIONEntities : DbContext
    {
        public DB_UNIVERSITY_REGISTRATIONEntities()
            : base("name=DB_UNIVERSITY_REGISTRATIONEntities")
        {
        }
        ...
        public virtual DbSet<T_PROFESSOR> T_PROFESSOR { get; set; }
        public virtual DbSet<T_REGISTRATION> T_REGISTRATION { get; set; }
